...
declare const enum GameActivity {
    ...
    DOTA_TELEPORT_STATUE = 1754,
    DOTA_IDLE_STATUE = 1755,
    DOTA_LOADOUT_STATUE = 1756,
    DOTA_CAST_1_STATUE = 1757,
    DOTA_ATTACK_STATUE = 1758,
    DOTA_FLAIL_STATUE = 1759,
    DOTA_STUN_STATUE = 1760,
    DOTA_TELEPORT_END_STATUE = 1761,
    DOTA_DEFEAT_STATUE = 1762,
    DOTA_VICTORY_STATUE = 1763,
    DOTA_FORCESTAFF_STATUE = 1764,
    DOTA_TAUNT_STATUE = 1765,
    DOTA_CAST_3_STATUE = 1766,
    DOTA_CHANNEL_STATUE = 1767,
    DOTA_ARCANA_VOTE = 1768,
    DOTA_SPIRIT_BREAKER_ULT_RUN = 1769,
    DOTA_PUNCH = 1770,
    DOTA_CAST_STATUE = 1771,
    DOTA_STATUE_SEQUENCE = 1772,
    DOTA_STORM_ABILITY_4 = 1773,
    DOTA_RUN_STATUE = 1774,
    DOTA_CAST_4_STATUE = 1775,
...
declare const enum SourceEngineAnimationEvent {
    ...
    NPC_LEFTFOOT = 1,
    NPC_RIGHTFOOT = 2,
    NPC_BODYDROP_LIGHT = 3,
    NPC_BODYDROP_HEAVY = 4,
    NPC_SWISHSOUND = 5,
    NPC_180_TURN = 6,
    NPC_ITEM_PICKUP = 7,
    NPC_WEAPON_DROP = 8,
    NPC_WEAPON_SET_SEQUENCE_NAME = 9,
    NPC_WEAPON_SET_SEQUENCE_NUMBER = 10,
    NPC_WEAPON_SET_ACTIVITY = 11,
    NPC_HOLSTER = 12,
    NPC_DRAW = 13,
    NPC_WEAPON_FIRE = 14,
    CL_PLAYSOUND = 15,
    CL_PLAYSOUND_ATTACHMENT = 16,
    SV_PLAYSOUND = 17,
    CL_STOPSOUND = 18,
    START_SCRIPTED_EFFECT = 19,
    STOP_SCRIPTED_EFFECT = 20,
    CLIENT_EFFECT_ATTACH = 21,
    MUZZLEFLASH = 22,
    NPC_MUZZLEFLASH = 23,
    THUMPER_THUMP = 24,
    AMMOCRATE_PICKUP_AMMO = 25,
    NPC_RAGDOLL = 26,
    NPC_ADDGESTURE = 27,
    NPC_RESTARTGESTURE = 28,
    NPC_ATTACK_BROADCAST = 29,
    NPC_HURT_INTERACTION_PARTNER = 30,
    NPC_SET_INTERACTION_CANTDIE = 31,
    SV_DUSTTRAIL = 32,
    CL_CREATE_PARTICLE_EFFECT = 33,
    CL_STOP_PARTICLE_EFFECT = 34,
    CL_ADD_PARTICLE_EFFECT_CP = 35,
    CL_CREATE_PARTICLE_BRASS = 36,
    RAGDOLL = 37,
    CL_ENABLE_BODYGROUP = 38,
    CL_DISABLE_BODYGROUP = 39,
    CL_BODYGROUP_SET_VALUE = 40,
    SV_BODYGROUP_SET_VALUE = 41,
    CL_BODYGROUP_SET_VALUE_CMODEL_WPN = 42,
    WPN_PRIMARYATTACK = 43,
    WPN_INCREMENTAMMO = 44,
    WPN_HIDE = 45,
    WPN_UNHIDE = 46,
    WPN_PLAYWPNSOUND = 47,
    MARINE_FOOTSTEP = 49,
    MARINE_RELOAD_SOUND_A = 50,
    MARINE_RELOAD_SOUND_B = 51,
    MARINE_RELOAD_SOUND_C = 52,
    REMOVE_CLIENT_AIM = 53,
    FOOTSTEP_LEFT = 54,
    FOOTSTEP_RIGHT = 55,
    ATTACK_START = 56,
    ATTACK_HIT = 57,
    ...
    RELOAD_CLIPOUT = 65,
    RELOAD_CLIPIN = 66,
    RELOAD_EMPTY_CLIPOUT = 67,
    RELOAD_EMPTY_CLIPIN = 68,
    RELOAD_EMPTY_CLIPIN_2 = 69,
    RELOAD_SHELL_INSERT = 70,
    RELOAD_PUMPEND = 71,
