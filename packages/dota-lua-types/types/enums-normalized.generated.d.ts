...
declare const enum GameActivity {
    ...
    DOTA_ARCANA_VOTE = 1762,
    DOTA_SPIRIT_BREAKER_ULT_RUN = 1763,
    DOTA_PUNCH = 1764,
    DOTA_CAST_STATUE = 1765,
    DOTA_ATTACK_STATUE = 1766,
    DOTA_CAST_3_STATUE = 1767,
    DOTA_CAST_1_STATUE = 1768,
    DOTA_TELEPORT_STATUE = 1769,
    DOTA_VICTORY_STATUE = 1770,
    DOTA_TAUNT_STATUE = 1771,
    DOTA_STATUE_SEQUENCE = 1772,
    DOTA_RUN_STATUE = 1773,
    DOTA_IDLE_STATUE = 1774,
    DOTA_CAST_4_STATUE = 1775,
    DOTA_FLAIL_STATUE = 1776,
    DOTA_STUN_STATUE = 1777,
    DOTA_TELEPORT_END_STATUE = 1778,
    DOTA_DISABLED_END = 1779,
    DOTA_RELAX_IN = 1781,
    DOTA_RELAX_OUT = 1782,
    DOTA_CAST_FENCE = 1783,
    DOTA_RADIANT_CREEP_HAMMER = 1785,
    DOTA_SPWN = 1786,
    DOTA_RUN_ALT = 1787,
