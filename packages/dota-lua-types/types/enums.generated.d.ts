...
declare enum GameActivity_t {
    ...
    ACT_DOTA_VOODOO_REST = 1759,
    ACT_DOTA_RUN_STATUE = 1760,
    ACT_DOTA_SPAWN_STATUE = 1761,
    ACT_DOTA_IDLE_STATUE = 1762,
    ACT_DOTA_ATTACK_STATUE = 1763,
    ACT_DOTA_CAST1_STATUE = 1764,
    ACT_DOTA_CAST3_STATUE = 1765,
    ACT_DOTA_CAST4_STATUE = 1766,
    ACT_DOTA_STUN_STATUE = 1767,
    ACT_DOTA_FLAIL_STATUE = 1768,
    ACT_DOTA_CAST2_STATUE = 1769,
    ACT_DOTA_TAUNT_STATUE = 1770,
    ACT_DOTA_LOADOUT_FRONTPAGE = 1771,
    ACT_DOTA_LOADOUT_FRONTPAGE_POPUP = 1772,
    ACT_DOTA_CRATER_CLOSED = 1775,
    ACT_DOTA_CRATER_OPEN = 1776,
    ACT_DOTA_DIE_ILLUSION = 1777,
    ACT_DOTA_CAST_STATUE = 1779,
    ACT_DOTA_BATTLEPASS_IDLE = 1780,
    ACT_DOTA_FORCESTAFF_STATUE = 1781,
    ACT_DOTA_TELEPORT_STATUE = 1782,
    ACT_DOTA_CHANNEL_STATUE = 1783,
    ACT_DOTA_VICTORY_STATUE = 1784,
    ACT_DOTA_LOADOUT_STATUE = 1785,
    ACT_DOTA_DEFEAT_STATUE = 1786,
    ACT_DOTA_ARCANA_STATUE = 1787,
    ACT_DOTA_REWARD_CELL = 1788,
    ACT_DOTA_FRONTPAGE = 1789,
    ACT_DOTA_TELEPORT_END_STATUE = 1790,
    ACT_DOTA_DISABLED_END = 1792,
    ACT_DOTA_RELAX_IN = 1793,
    ACT_DOTA_RELAX_OUT = 1794,
    ACT_DOTA_CAST_FENCE = 1795,
    ACT_DOTA_RADIANT_CREEP_HAMMER = 1797,
    ACT_DOTA_SPWN = 1798,
    ACT_DOTA_RUN_ALT = 1799,
    ACT_DOTA_CYCLONE = 1800,
    ACT_DOTA_IMPALE = 1801,
}
