...
declare enum GameActivity_t {
    ...
    ACT_DOTA_IDLE_STATUE = 1759,
    ACT_DOTA_RUN_STATUE = 1760,
    ACT_DOTA_STUN_STATUE = 1761,
    ACT_DOTA_FLAIL_STATUE = 1762,
    ACT_DOTA_CAST_STATUE = 1763,
    ACT_DOTA_ATTACK_STATUE = 1764,
    ACT_DOTA_SPAWN_STATUE = 1765,
    ACT_DOTA_DEFEAT_STATUE = 1766,
    ACT_DOTA_FORCESTAFF_STATUE = 1767,
    ACT_DOTA_TELEPORT_STATUE = 1768,
    ACT_DOTA_DISABLED_END = 1769,
    ACT_DOTA_RUN_ALT = 1771,
    ACT_DOTA_CYCLONE = 1772,
    ACT_DOTA_IMPALE = 1773,
    ACT_DOTA_TORRENT = 1774,
    ACT_DOTA_RELAX_IN = 1775,
    ACT_DOTA_RELAX_OUT = 1776,
    ACT_DOTA_CAST_FENCE = 1777,
    ACT_DOTA_RADIANT_CREEP_HAMMER = 1779,
}
