...
declare enum SourceEngineAnimationEvent {
    ...
    AE_FIRE_INPUT = 37,
    AE_CL_CLOTH_ATTR = 38,
    AE_CL_CLOTH_GROUND_OFFSET = 39,
    AE_CL_CLOTH_STIFFEN = 40,
    AE_CL_CLOTH_EFFECT = 41,
    AE_CL_CREATE_ANIM_SCOPE_PROP = 42,
    AE_HAPTIC_PULSE = 43,
    AE_CL_DOTA_PLAY_STATUS_EFFECT = 44,
    AE_CL_DOTA_STOP_STATUS_EFFECT = 45,
    AE_CL_DOTA_NPC_CREATE_PARTICLE_EFFECT = 46,
    AE_CL_DOTA_RUBICK_ARCANA_CREATE_PARTICLE_EFFECT = 47,
    AE_DOTA_PET_ITEM_PICKUP = 48,
    AE_DOTA_PET_ITEM_DROP = 49,
    AE_DOTA_SUPPRESS_CONSTANT_LAYER = 50,
    AE_DOTA_PLAY_SOUND_ATTACK_SPECIAL = 51,
    AE_DOTA_CREATE_CLINKZ_ATTACK = 52,
    AE_DOTA_PLAY_SOUND_ATTACK_BACKSTAB = 53,
    AE_DOTA_DIE_PHANTOM_DEATH_PARTICLES = 54,
    AE_DOTA_SWITCH_ATTACK_COMBO = 55,
