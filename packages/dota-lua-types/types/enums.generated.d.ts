...
declare enum GameActivity_t {
    ...
    ACT_DOTA_AGHANIM_BLINK_TRAIL = 1760,
    ACT_DOTA_DISABLED_END = 1761,
    ACT_DOTA_IDLE_STATUE = 1765,
    ACT_DOTA_SPAWN_STATUE = 1766,
    ACT_DOTA_FLAIL_STATUE = 1767,
    ACT_DOTA_STUN_STATUE = 1768,
    ACT_DOTA_FORCESTAFF_STATUE = 1769,
    ACT_DOTA_VICTORY_STATUE = 1770,
    ACT_DOTA_RUN_STATUE = 1771,
    ACT_DOTA_DASHBOARD = 1773,
    ACT_DOTA_RADIANT_CREEP_HAMMER = 1776,
    ACT_DOTA_RELAX_IN = 1777,
    ACT_DOTA_RELAX_OUT = 1778,
    ACT_DOTA_CAST_FENCE = 1779,
    ACT_DOTA_SPWN = 1781,
